...
const BrandLogo = () => (
  <div className="flex flex-col items-center leading-tight">
    <span className="font-serif text-[16px] sm:text-lg md:text-2xl font-light tracking-tight text-text-primary leading-none">Foster Brand Development</span>
  </div>
);
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="bg-accent-blue text-white px-4 md:px-6 py-2 md:py-2.5 rounded-full text-xs md:text-[14px] font-medium hover:bg-accent-blue-dark hover:scale-[1.03] transition-all cursor-pointer whitespace-nowrap"
            >
              Start a project
            </button>
          </div>
